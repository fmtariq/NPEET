...
print("result1:", [ee.entropy([[2 * random.random()] for i in range(1000)], k=j + 1) for j in range(5)])
print("result2:", [ee.entropy([[0] for i in range(1000)], k=j + 1) for j in range(5)])
